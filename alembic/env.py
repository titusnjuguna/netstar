...
from api.db.session import Base,DATABASE_URL
...
# Allow the DB target to be overridden via the DATABASE_URL env var (e.g. in Docker),
# falling back to the value configured in alembic.ini.
